...
client.on('ready', () => {
    ...
    const ttvNotify = require('../../src/backend/commands/events/modules/ttvNotify')(client);
    const ytNotify = require('../../src/backend/commands/events/modules/ytNotify')(client);
})
